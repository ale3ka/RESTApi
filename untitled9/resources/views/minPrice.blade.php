...
<head>
    ...
    <script type="text/javascript">
        ...
        if (xmlhttp) {
            ...
            xmlhttp.open("GET","http://localhost/untitled9/public/stations/minPrice",true);
                ...
                if(xmlhttp.readyState==4 && xmlhttp.status==200) {
                    ...
                    for(var i=0; i<7; i++){
                            ...
                            if(stations[i].fuelTypeID==i) {
                                ...
                                data.count[i]=stations[i].min_price;
                    ...
                    function drawChart() {
                        ...
                        for(i=0;i<obj.length;i++){
                            ...
                            datas.setCell(i,1, obj[i].min_price);
                        ...
                        var chart = new google.visualization.ColumnChart(document.getElementById('min_chart_div'));
...
<div id="min_chart_div" style="width: 900px; height: 500px;"></div>
</body>
</html>